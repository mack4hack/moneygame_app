...
public class Container extends Fragment {
    ...
    public static Container newInstance(int sectionNumber) {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        try {
            ...
            tab1.setContent(new Intent(getActivity(), CricketAccounts.class));

            tab2.setIndicator("Last Week");
            ;
            tab2.setContent(new Intent(getActivity(), CricketAccountsLastWeek.class));
